            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  ...
                  <div className="text-text-primary text-lg font-mono">jason.k@example.com</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  ...
                  <div className="text-text-primary text-lg font-mono">+1 (555) 012-3456</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  ...
                  <div className="text-text-primary text-lg font-mono">San Francisco, CA</div>
                </div>
              </div>
            </div>
          </div>
